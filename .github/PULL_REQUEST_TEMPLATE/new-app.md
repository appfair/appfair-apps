<!-- A first submission: a new file under apps/<token>.yaml. -->
...
<!-- A paragraph. The store listing lives in the app's repository; this is for the people
...
- [ ] The store listing in the app's repository is complete, including screenshots.
